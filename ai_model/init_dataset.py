...
def create(dataset_location, imgsz, sliced_dir, yolo_dataset):
    try:
        os.rmdir(sliced_dir)
    except:
        pass
    ...
    coco_dict, coco_path = slice_coco(
        coco_annotation_file_path=f"{dataset_location}/train/_annotations.coco.json",
        image_dir=f"{dataset_location}/train",
...
create(dataset.location, 512, "sliced", "yolo_dataset")
create(dataset.location, 1080, "sliced_big", "yolo_dataset_big")
